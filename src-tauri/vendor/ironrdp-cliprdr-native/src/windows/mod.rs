...
pub use self::file_clipboard::{
    FileClipboardProgress, clear_file_clipboard, file_clipboard_progress, file_clipboard_ready,
...
impl WinClipboard {
    ...
    pub fn new<P>(message_proxy: P) -> WinCliprdrResult<Self>
    where
        P: ClipboardMessageProxy + Clone + 'static,
    {
        ...
        let shared_proxy: SharedMessageProxy = Arc::new(Mutex::new(Box::new(message_proxy.clone())));
